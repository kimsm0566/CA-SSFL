...
DOC_ROOT="${REPO_ROOT}/docs/experiments/2026-04-11/2026-04-11_17-05_v01_rayleigh-fixed-base-variable-refinement-seed34"
...
main() {
  touch "${LOG_FILE}"
  log "rayleigh fixed-base variable-refinement seed34 extension 시작"
  for seed in 3 4; do
    run_one "${seed}"
  done
  log "rayleigh fixed-base variable-refinement seed34 extension 완료"
}
