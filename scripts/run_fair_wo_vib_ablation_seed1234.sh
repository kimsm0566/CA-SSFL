...
DOC_ROOT="${REPO_ROOT}/docs/experiments/2026-04-15/2026-04-15_14-55_v01_fair-wo-vib-ablation-plan"
RUNLOG_FILE="${DOC_ROOT}/RUNLOG.md"
SUDO_PASSWORD="${SUDO_PASSWORD:-a}"

RESULT_ROOT="/workspace/tmp/2026-04-15/2026-04-15-cifar10-fair-wo-vib-ablation"
HOST_RESULT_ROOT="${REPO_ROOT}/tmp/2026-04-15/2026-04-15-cifar10-fair-wo-vib-ablation"
...
run_one() {
  ...
  label="cifar10_${channel}_SSFLv6_w_o_vib_fair_seed_${seed}"
  ...
  if run_exp \
    "${label}" \
    --dataset cifar10 --partition_type class --algorithm SSFLv6_w_o_vib_fair --model_type resnetv2 \
...
main() {
  ...
  : > "${RUNLOG_FILE}"
  log_to "fair w/o VIB ablation 시작"
  ...
  log_to "fair w/o VIB ablation 완료"
}
