...
RESULT_ROOT="/workspace/tmp/2026-04-14/2026-04-14-cifar100-rayleigh-threeway-benchmark-updated-ca-ssfl"
HOST_RESULT_ROOT="${REPO_ROOT}/tmp/2026-04-14/2026-04-14-cifar100-rayleigh-threeway-benchmark-updated-ca-ssfl"
DOC_ROOT="${REPO_ROOT}/docs/experiments/2026-04-14/2026-04-14_00-40_v01_cifar100-cross-benchmark-updated-ca-ssfl"
LOG_FILE="${DOC_ROOT}/RUNLOG_RAYLEIGH.md"
...
main() {
  touch "${LOG_FILE}"
  log "cifar100 rayleigh three-way benchmark (updated CA-SSFL) 시작"

  for seed in 1 2 3 4; do
    run_one "cifar100_rayleigh_sfl_seed_${seed}" "SFL" "4096" "${seed}" || true
  done

  for seed in 1 2 3 4; do
    run_one "cifar100_rayleigh_scusfl_seed_${seed}" "SC-USFL" "1352" "${seed}" || true
  done

  for seed in 1 2 3 4; do
    run_one "cifar100_rayleigh_ca_ssfl_seed_${seed}" "SSFLv6" "4096" "${seed}" || true
  done

  log "cifar100 rayleigh three-way benchmark (updated CA-SSFL) 완료"
}
