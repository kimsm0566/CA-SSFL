...
RESULT_ROOT="/workspace/tmp/2026-04-11/2026-04-11-cifar100-rayleigh-threeway-benchmark-nclients8"
HOST_RESULT_ROOT="${REPO_ROOT}/tmp/2026-04-11/2026-04-11-cifar100-rayleigh-threeway-benchmark-nclients8"
...
main() {
  touch "${LOG_FILE}"
  log "cifar100 rayleigh three-way benchmark 시작"

  for seed in 1 2 3 4; do
    run_one "cifar100_rayleigh_sfl_seed_${seed}" "SFL" "4096" "${seed}"
  done

  for seed in 1 2 3 4; do
    run_one "cifar100_rayleigh_scusfl_seed_${seed}" "SC-USFL" "1352" "${seed}"
  done

  for seed in 1 2 3 4; do
    run_one "cifar100_rayleigh_ca_ssfl_seed_${seed}" "SSFLv6" "4096" "${seed}"
  done

  log "cifar100 rayleigh three-way benchmark 완료"
}
