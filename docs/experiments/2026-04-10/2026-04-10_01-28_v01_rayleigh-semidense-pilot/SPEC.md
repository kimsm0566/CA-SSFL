...
- `SSFLv6 + semidense(group_size=16, group_topk=4)`, seed `1,2`
- `SSFLv6 + semidense(group_size=16, group_topk=8)`, seed `1,2`
- `SSFLv6 + semidense(group_size=32, group_topk=8)`, seed `1,2`
...
- semidense_enable: `1`
- mpi_trace_enable: `0`
- result_path: `/workspace/tmp/2026-04-10-rayleigh-semidense-pilot`
...
- Docker GPU smoke:
  - `group_size=16`, `group_topk=4`, seed `1`, `n_rounds=1`
